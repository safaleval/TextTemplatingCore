...
Generate **any** text, template, code **any** language, **any** script from your domain c# code, include it in your continous integration... veeery useful stuff! See DesignTimeSample etc.
